...
private:
	...
	AVLTree<std::shared_ptr<User>, int>* users = nullptr;
	AVLTree<std::shared_ptr<Group>, int>* groups= nullptr;
	AVLTree<std::shared_ptr<Movie>, int>* moviesByID= nullptr;
	AVLTree<std::shared_ptr<Movie>, std::shared_ptr<Movie>>* moviesByGrade= nullptr;
	AVLTree<std::shared_ptr<Movie>, std::shared_ptr<Movie>>* actionByGrade= nullptr;
	AVLTree<std::shared_ptr<Movie>, std::shared_ptr<Movie>>* dramaByGrade= nullptr;
	AVLTree<std::shared_ptr<Movie>, std::shared_ptr<Movie>>* comedyByGrade= nullptr;
	AVLTree<std::shared_ptr<Movie>, std::shared_ptr<Movie>>* fantasyByGrade= nullptr;
